...
var explorers = {
  ...
  mechanics: [
    ...
    },
    {
      ...
      name: "Evil Eyes",
      spellId: 1292764,
      what: "Statues project spirit flames at player locations , hitting within 3 yds, and leave burning ground; the highest cast volume in the fight.",
      from: "iku",
      roles: ["tank", "dps", "healer"],
      telegraphMs: 2e3,
    ...
    },
    {
      ...
      name: "Shell Spin",
      spellId: 1291918,
      what: "Three spinning shells in a frontal cone; contact stuns 4s, no dispel type.",
      from: "nama",
      roles: ["tank", "dps", "healer"],
      telegraphMs: 3e3,
    ...
    },
    {
      ...
      spellId: 1295858,
      what: "Tank channel \u2014 shards every 0.5s for 4s, each stack adding +50% damage taken from it.",
      from: "iku",
      roles: ["tank"],
      telegraphMs: 1500,
      origin: "boss",
    ...
    },
    {
      ...
      name: "Mighty Thud",
      spellId: 1300237,
      what: "Nama marks three players and leaps at each; impact damage splits among everyone in the landing zone, and the crater then quakes.",
      lethal: true,
      from: "nama",
      roles: ["tank", "dps", "healer"],
      telegraphMs: 4e3,
    ...
    },
    {
      ...
      name: "Splinters",
      spellId: 1308853,
      what: "Gebbo hurls crates around the arena \u2014 landing crates damage anyone underneath, clipping one applies Splinters (stacking Physical bleed, spreads on Mythic), and a crate left alive ~25s ruptures raid-wide. Breaking crates drops the fish.",
      lethal: true,
      from: "gebbo",
      roles: ["tank", "dps", "healer"],
      telegraphMs: 8e3,
    ...
    },
    {
      ...
      spellId: 1296245,
      what: "Gebbo bombs a marked player \u2014 impact hits everyone within 10 yds, leaves a 12s Fire DoT (Concussive Blast), and sends a ground-level fire wave out. Mushroom Toss spawns the Bouncy Mushrooms that are the only answer to it.",
      lethal: true,
      from: "gebbo",
      roles: ["tank", "dps", "healer"],
      telegraphMs: 1e4,
    ...
    },
    {
      ...
      spellId: 1295450,
      what: "1295450 is constant raid-wide Shadow damage every 2s; 1313303 is the burst plus 12s DoT the raid eats on every successful fish.",
      from: "morzahi",
      roles: ["healer"],
      telegraphMs: 0,
      origin: "boss",
...
var sszorak = {
  ...
  mechanics: [
    ...
    },
    {
      ...
      name: "Tempest",
      spellId: 1287083,
      what: "Poisonous vortices spiral the arena; touching one deals Nature damage, DoTs you and slows you 30% for 6s \u2014 the slow is the lethal part, because it strands you in the wind.",
      roles: ["healer"],
      telegraphMs: 5e3,
      shape: { kind: "circle", radius: 5 },
      origin: "random",
    ...
    },
    {
      ...
      name: "Caustic Claws",
      spellId: 1305998,
      what: "Toxin flung from his claws deals Nature damage in a 6yd radius and leaves an acid pool that ticks damage and adds +30% damage taken from every school.",
      roles: ["tank", "dps", "healer"],
      telegraphMs: 2200,
      shape: { kind: "circle", radius: 6 },
      // "6yd radius"
    ...
    },
    {
      ...
      name: "Venomous Surge",
      spellId: 1306120,
      what: "Players are drenched for 10s , then burst for damage that falls off with distance and drop a cyst that pops on contact for damage and a 30% slow .",
      roles: ["tank", "dps", "healer"],
      telegraphMs: 1e4,
    ...
    },
    {
      ...
      spellId: 1285616,
      what: "An 8s wind debuff that explodes on expiry and knocks everyone hit in its direction (two directions on Heroic, four on Mythic), leaving them aloft 10s with slow fall \u2014 colliding with another aloft player drops both.",
      roles: ["tank", "dps", "healer"],
      telegraphMs: 8e3,
