// Fight music.
//
// The app ships with NO audio file committed — `public/music/*.mp3` is
// gitignored. Drop your own track at `public/music/pull.mp3` and it plays when a
// pull starts; if the file is absent, everything works in silence.
//
// See ATTRIBUTION.md.
