  ...
  return (
    <div className="debrief">
      ...
      <div className="debrief-stats">
        ...
        {/* The stack economy, on the one fight that has one. Two numbers, not
            one, because they are answered differently: your own peak is where
            you stood, and the raid's is whether the soak rota held. A pull lost
            to globules nobody swept looks identical to a pull lost to bad
